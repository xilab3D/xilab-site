...
<div class="tarifs-grid" style="display:grid; grid-template-columns:1fr 1fr; gap:16px; margin:16px 0;">

<div class="tarif-card expert" style="margin:0;">
<div class="tarif-name">PhD — Doctorat</div>
<div style="font-size:0.85rem; color:var(--secondary);">Université de Reims Champagne-Ardenne · 2002–2005</div>
<ul>
<li>Modélisation connaissance / IA symbolique</li>
<li>Chaîne numérique → Simulation numérique</li>
</ul>
</div>

<div class="tarif-card expert" style="margin:0;">
<div class="tarif-name">HDR — Habilitation à Diriger des Recherches</div>
<div style="font-size:0.85rem; color:var(--secondary);">Université de Reims Champagne-Ardenne · 2020</div>
<ul>
<li>Principes de modélisation / simulation pluridisciplinaires</li>
<li>Jumeaux Numériques</li>
</ul>
</div>
...
**Réseaux de Neurones pour Jumeaux Numériques**
...
## Responsabilités et animation

- Co-animateur de l'atelier « IA pour l'ingénieur » de l'association MICADO — animation de sessions de travail sur l'intégration de l'IA dans les processus d'ingénierie
